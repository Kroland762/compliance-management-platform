...
QuestionItem.init(
  {
    ...
    answerStatus: { type: DataTypes.ENUM(...Object.values(AnswerStatus)), allowNull: false, defaultValue: AnswerStatus.PENDING },
    complianceStatus: { type: DataTypes.ENUM(...Object.values(ComplianceStatus)), allowNull: true },
    riskIdentification: { type: DataTypes.STRING(100), allowNull: true },
    riskLevel: { type: DataTypes.ENUM(...Object.values(RiskLevel)), allowNull: true },
