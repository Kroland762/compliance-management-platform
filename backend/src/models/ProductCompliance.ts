...
interface PermissionAttributes { id: string; dossierId: string; platform: string; operatingSystem: string | null; permissionName: string; purpose: string; required: boolean; inheritedFromPermissionId: string | null; sortOrder: number; }
type PermissionCreation = Optional<PermissionAttributes, 'id' | 'operatingSystem' | 'required' | 'inheritedFromPermissionId' | 'sortOrder'>;
export class ProductPlatformPermission extends Model<PermissionAttributes, PermissionCreation> implements PermissionAttributes {
  declare id: string; declare dossierId: string; declare platform: string; declare operatingSystem: string | null; declare permissionName: string; declare purpose: string; declare required: boolean; declare inheritedFromPermissionId: string | null; declare sortOrder: number;
}
ProductPlatformPermission.init({
  id: { type: DataTypes.UUID, defaultValue: DataTypes.UUIDV4, primaryKey: true }, dossierId: { type: DataTypes.UUID, allowNull: false }, platform: { type: DataTypes.STRING(50), allowNull: false }, operatingSystem: { type: DataTypes.STRING(80), allowNull: true }, permissionName: { type: DataTypes.STRING(160), allowNull: false }, purpose: { type: DataTypes.TEXT, allowNull: false },
...
interface DataCatalogAttributes { id: string; stableKey: string; dataSubject: string; category: string; name: string; sensitive: boolean; required: boolean; status: ProductTypeStatus; sortOrder: number; createdBy: string; createdAt: Date; updatedAt: Date; }
type DataCatalogCreation = Optional<DataCatalogAttributes, 'id' | 'sensitive' | 'required' | 'status' | 'sortOrder' | 'createdAt' | 'updatedAt'>;
export class ProductDataCatalogItem extends Model<DataCatalogAttributes, DataCatalogCreation> implements DataCatalogAttributes {
  declare id: string; declare stableKey: string; declare dataSubject: string; declare category: string; declare name: string; declare sensitive: boolean; declare required: boolean; declare status: ProductTypeStatus; declare sortOrder: number; declare createdBy: string; declare createdAt: Date; declare updatedAt: Date;
}
ProductDataCatalogItem.init({
  id: { type: DataTypes.UUID, defaultValue: DataTypes.UUIDV4, primaryKey: true }, stableKey: { type: DataTypes.STRING(120), allowNull: false }, dataSubject: { type: DataTypes.STRING(160), allowNull: false }, category: { type: DataTypes.STRING(120), allowNull: false }, name: { type: DataTypes.STRING(160), allowNull: false },
  sensitive: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false }, required: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false }, status: { type: DataTypes.STRING(20), allowNull: false, defaultValue: 'active', validate: { isIn: [['active', 'retired']] } }, sortOrder: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  createdBy: { type: DataTypes.UUID, allowNull: false }, createdAt: { type: DataTypes.DATE, defaultValue: DataTypes.NOW }, updatedAt: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
}, { sequelize, tableName: 'product_data_catalog_items', timestamps: true, indexes: [{ unique: true, fields: ['stableKey'] }, { fields: ['status', 'sortOrder'] }] });

interface DataItemAttributes { id: string; dossierId: string; catalogItemId: string | null; name: string; category: string; dataSubjectCategories: string[]; purpose: string | null; necessity: string | null; processingMethod: string | null; operatingSystems: string[]; source: string | null; sensitive: boolean; required: boolean; notes: string | null; inheritedFromDataItemId: string | null; sortOrder: number; }
type DataItemCreation = Optional<DataItemAttributes, 'id' | 'catalogItemId' | 'dataSubjectCategories' | 'purpose' | 'necessity' | 'processingMethod' | 'operatingSystems' | 'source' | 'sensitive' | 'required' | 'notes' | 'inheritedFromDataItemId' | 'sortOrder'>;
export class ProductDataItem extends Model<DataItemAttributes, DataItemCreation> implements DataItemAttributes {
  declare id: string; declare dossierId: string; declare catalogItemId: string | null; declare name: string; declare category: string; declare dataSubjectCategories: string[]; declare purpose: string | null; declare necessity: string | null; declare processingMethod: string | null; declare operatingSystems: string[]; declare source: string | null; declare sensitive: boolean; declare required: boolean; declare notes: string | null; declare inheritedFromDataItemId: string | null; declare sortOrder: number;
}
ProductDataItem.init({
  id: { type: DataTypes.UUID, defaultValue: DataTypes.UUIDV4, primaryKey: true }, dossierId: { type: DataTypes.UUID, allowNull: false }, catalogItemId: { type: DataTypes.UUID, allowNull: true }, name: { type: DataTypes.STRING(160), allowNull: false }, category: { type: DataTypes.STRING(120), allowNull: false },
  dataSubjectCategories: { type: DataTypes.JSONB, allowNull: false, defaultValue: [] }, purpose: { type: DataTypes.TEXT, allowNull: true }, necessity: { type: DataTypes.STRING(40), allowNull: true }, processingMethod: { type: DataTypes.STRING(160), allowNull: true }, operatingSystems: { type: DataTypes.JSONB, allowNull: false, defaultValue: [] }, source: { type: DataTypes.STRING(200), allowNull: true }, sensitive: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false }, required: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false }, notes: { type: DataTypes.TEXT, allowNull: true }, inheritedFromDataItemId: { type: DataTypes.UUID, allowNull: true }, sortOrder: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
}, { sequelize, tableName: 'product_data_items', timestamps: false, indexes: [{ fields: ['dossierId', 'sortOrder'] }] });

interface ActivityAttributes { id: string; dossierId: string; name: string; purpose: string; legalBasis: string; controllerRole: string; dataSubjectCategories: string[]; recipientCategories: string[]; internationalTransfer: boolean; transferCountries: string[]; transferSafeguards: string | null; dataSource: string | null; writesToLog: boolean | null; dataScale: string | null; transferPath: string | null; transferEncryption: string | null; thirdPartyProcessor: string | null; thirdPartyProcessingAgreement: boolean | null; stored: boolean | null; storageSystem: string | null; storageLocation: string | null; storageEncryption: string | null; accessControl: string | null; anonymization: string | null; systemLogging: string | null; bulkExportAllowed: boolean | null; retentionPeriod: string; deletionMechanism: string | null; retentionBasis: string | null; securityMeasures: string; responsibleParty: string; inheritedFromActivityId: string | null; sortOrder: number; }
type ActivityCreation = Optional<ActivityAttributes, 'id' | 'controllerRole' | 'dataSubjectCategories' | 'recipientCategories' | 'internationalTransfer' | 'transferCountries' | 'transferSafeguards' | 'dataSource' | 'writesToLog' | 'dataScale' | 'transferPath' | 'transferEncryption' | 'thirdPartyProcessor' | 'thirdPartyProcessingAgreement' | 'stored' | 'storageSystem' | 'storageLocation' | 'storageEncryption' | 'accessControl' | 'anonymization' | 'systemLogging' | 'bulkExportAllowed' | 'deletionMechanism' | 'retentionBasis' | 'inheritedFromActivityId' | 'sortOrder'>;
export class ProductProcessingActivity extends Model<ActivityAttributes, ActivityCreation> implements ActivityAttributes {
  declare id: string; declare dossierId: string; declare name: string; declare purpose: string; declare legalBasis: string; declare controllerRole: string; declare dataSubjectCategories: string[]; declare recipientCategories: string[]; declare internationalTransfer: boolean; declare transferCountries: string[]; declare transferSafeguards: string | null; declare dataSource: string | null; declare writesToLog: boolean | null; declare dataScale: string | null; declare transferPath: string | null; declare transferEncryption: string | null; declare thirdPartyProcessor: string | null; declare thirdPartyProcessingAgreement: boolean | null; declare stored: boolean | null; declare storageSystem: string | null; declare storageLocation: string | null; declare storageEncryption: string | null; declare accessControl: string | null; declare anonymization: string | null; declare systemLogging: string | null; declare bulkExportAllowed: boolean | null; declare retentionPeriod: string; declare deletionMechanism: string | null; declare retentionBasis: string | null; declare securityMeasures: string; declare responsibleParty: string; declare inheritedFromActivityId: string | null; declare sortOrder: number;
}
ProductProcessingActivity.init({
  ...
  dataSource: { type: DataTypes.TEXT, allowNull: true }, writesToLog: { type: DataTypes.BOOLEAN, allowNull: true }, dataScale: { type: DataTypes.TEXT, allowNull: true }, transferPath: { type: DataTypes.TEXT, allowNull: true }, transferEncryption: { type: DataTypes.TEXT, allowNull: true },
  thirdPartyProcessor: { type: DataTypes.TEXT, allowNull: true }, thirdPartyProcessingAgreement: { type: DataTypes.BOOLEAN, allowNull: true }, stored: { type: DataTypes.BOOLEAN, allowNull: true }, storageSystem: { type: DataTypes.TEXT, allowNull: true }, storageLocation: { type: DataTypes.TEXT, allowNull: true },
  storageEncryption: { type: DataTypes.TEXT, allowNull: true }, accessControl: { type: DataTypes.TEXT, allowNull: true }, anonymization: { type: DataTypes.TEXT, allowNull: true }, systemLogging: { type: DataTypes.TEXT, allowNull: true }, bulkExportAllowed: { type: DataTypes.BOOLEAN, allowNull: true },
  deletionMechanism: { type: DataTypes.TEXT, allowNull: true }, retentionBasis: { type: DataTypes.TEXT, allowNull: true },
}, { sequelize, tableName: 'product_processing_activities', timestamps: false, indexes: [{ fields: ['dossierId', 'sortOrder'] }] });

interface ThirdPartyServiceAttributes { id: string; dossierId: string; serviceName: string; purpose: string; sharedFields: string[]; thirdPartyName: string | null; securityMethod: string | null; privacyPolicyUrl: string | null; assessmentPassed: boolean | null; assessmentRecord: string | null; inheritedFromServiceId: string | null; sortOrder: number; }
type ThirdPartyServiceCreation = Optional<ThirdPartyServiceAttributes, 'id' | 'sharedFields' | 'thirdPartyName' | 'securityMethod' | 'privacyPolicyUrl' | 'assessmentPassed' | 'assessmentRecord' | 'inheritedFromServiceId' | 'sortOrder'>;
export class ProductThirdPartyService extends Model<ThirdPartyServiceAttributes, ThirdPartyServiceCreation> implements ThirdPartyServiceAttributes {
  declare id: string; declare dossierId: string; declare serviceName: string; declare purpose: string; declare sharedFields: string[]; declare thirdPartyName: string | null; declare securityMethod: string | null; declare privacyPolicyUrl: string | null; declare assessmentPassed: boolean | null; declare assessmentRecord: string | null; declare inheritedFromServiceId: string | null; declare sortOrder: number;
}
ProductThirdPartyService.init({
  id: { type: DataTypes.UUID, defaultValue: DataTypes.UUIDV4, primaryKey: true }, dossierId: { type: DataTypes.UUID, allowNull: false }, serviceName: { type: DataTypes.STRING(200), allowNull: false }, purpose: { type: DataTypes.TEXT, allowNull: false }, sharedFields: { type: DataTypes.JSONB, allowNull: false, defaultValue: [] },
  thirdPartyName: { type: DataTypes.STRING(200), allowNull: true }, securityMethod: { type: DataTypes.TEXT, allowNull: true }, privacyPolicyUrl: { type: DataTypes.TEXT, allowNull: true }, assessmentPassed: { type: DataTypes.BOOLEAN, allowNull: true }, assessmentRecord: { type: DataTypes.TEXT, allowNull: true }, inheritedFromServiceId: { type: DataTypes.UUID, allowNull: true }, sortOrder: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
}, { sequelize, tableName: 'product_third_party_services', timestamps: false, indexes: [{ fields: ['dossierId', 'sortOrder'] }] });

interface ThirdPartyAssessmentAttributes { id: string; dossierId: string; serviceId: string | null; templateKey: string; title: string; inheritedFromAssessmentId: string | null; sortOrder: number; }
type ThirdPartyAssessmentCreation = Optional<ThirdPartyAssessmentAttributes, 'id' | 'serviceId' | 'templateKey' | 'inheritedFromAssessmentId' | 'sortOrder'>;
export class ProductThirdPartyAssessment extends Model<ThirdPartyAssessmentAttributes, ThirdPartyAssessmentCreation> implements ThirdPartyAssessmentAttributes {
  declare id: string; declare dossierId: string; declare serviceId: string | null; declare templateKey: string; declare title: string; declare inheritedFromAssessmentId: string | null; declare sortOrder: number;
}
ProductThirdPartyAssessment.init({
  id: { type: DataTypes.UUID, defaultValue: DataTypes.UUIDV4, primaryKey: true }, dossierId: { type: DataTypes.UUID, allowNull: false }, serviceId: { type: DataTypes.UUID, allowNull: true }, templateKey: { type: DataTypes.STRING(120), allowNull: false, defaultValue: 'third-party-security-v1' }, title: { type: DataTypes.STRING(200), allowNull: false },
  inheritedFromAssessmentId: { type: DataTypes.UUID, allowNull: true }, sortOrder: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
}, { sequelize, tableName: 'product_third_party_assessments', timestamps: false, indexes: [{ fields: ['dossierId', 'sortOrder'] }] });

interface ThirdPartyAssessmentAnswerAttributes { id: string; assessmentId: string; stableKey: string; section: string | null; sequence: string | null; item: string; answer: string | null; explanation: string | null; evidence: string | null; sortOrder: number; }
type ThirdPartyAssessmentAnswerCreation = Optional<ThirdPartyAssessmentAnswerAttributes, 'id' | 'section' | 'sequence' | 'answer' | 'explanation' | 'evidence' | 'sortOrder'>;
export class ProductThirdPartyAssessmentAnswer extends Model<ThirdPartyAssessmentAnswerAttributes, ThirdPartyAssessmentAnswerCreation> implements ThirdPartyAssessmentAnswerAttributes {
  declare id: string; declare assessmentId: string; declare stableKey: string; declare section: string | null; declare sequence: string | null; declare item: string; declare answer: string | null; declare explanation: string | null; declare evidence: string | null; declare sortOrder: number;
}
ProductThirdPartyAssessmentAnswer.init({
  id: { type: DataTypes.UUID, defaultValue: DataTypes.UUIDV4, primaryKey: true }, assessmentId: { type: DataTypes.UUID, allowNull: false }, stableKey: { type: DataTypes.STRING(120), allowNull: false }, section: { type: DataTypes.STRING(200), allowNull: true }, sequence: { type: DataTypes.STRING(40), allowNull: true }, item: { type: DataTypes.TEXT, allowNull: false },
  answer: { type: DataTypes.STRING(40), allowNull: true }, explanation: { type: DataTypes.TEXT, allowNull: true }, evidence: { type: DataTypes.TEXT, allowNull: true }, sortOrder: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
}, { sequelize, tableName: 'product_third_party_assessment_answers', timestamps: false, indexes: [{ unique: true, fields: ['assessmentId', 'stableKey'] }] });
